...
////////////////////////////////////////////////////////////////// Mantenimiento /////////////////////////////////////////
 ...
 const annoEditar = document.getElementById('institucionEditar');
 ...
 btnAgregar.addEventListener('click', () => {
     const nuevaPublicacion = {
      ...
      titulo_publicacion : document.getElementById('nombre').value,
      anno_publicacion : document.getElementById('titulo').value,
      nombre_revista : document.getElementById('institucion').value,
     };
 ...
 btnEditar.addEventListener('click', () => {
  ...
  selectPublicacion.addEventListener('change', () => {
    ...
    if (selectPublicacion) {
      ...
      tituloEditar.value = selectPublicacion.titulo_publicacion;
      annoEditar.value = selectPublicacion.anno_publicacion;
      nombreEditar.value = selectPublicacion.nombre_revista;
    }
  });
