const top_5_areas_conocimiento_URL = 'http://localhost:3000/api/top_5_areas_cononimiento';
...
get(top_5_areas_conocimiento_URL)
    .then((data) => {
        ...
        data.forEach((resultado) => {
            ...
            celdas[0].textContent = resultado.area; // Área de Conocimiento
            celdas[1].textContent = resultado.cantidad; // Cantidad de Proyectos
